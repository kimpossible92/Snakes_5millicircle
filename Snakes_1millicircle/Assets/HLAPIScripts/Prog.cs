...
public class Prog : NetworkBehaviour
{
    ...
    public override void OnStartLocalPlayer()
    {
        ...
        float randomx = randX[Random.Range(0, randX.Length)];
        int randomy = randY[Random.Range(0, randY.Length)];
        transform.position = new Vector3(randomx, randomy, 0);
        //CmdMoveWorm();
    }
    ...
    //int[] timePoints=new int[4];
    // Use this for initialization
    public void Start()
    {
        InvokeRepeating("AddSeconds", 1f, 1f);
        //for(int i = 0; i < timePoints.Length; i++)
        //{
        //    timePoints[i] = 60 / timePoints.Length * i;
        //}
        newHead = 0;
    ...
    void Update()
    {
        ...
        if (newHead == 1)
        {
            mDirection = Vector2.right * dirspeed*SpeedPlayer;
        }
        else if (newHead == 2)
        {
            mDirection = -Vector2.right * dirspeed*SpeedPlayer;
        ...
        {
            mDirection = Vector2.up * dirspeed*SpeedPlayer;
        }
        else if (newHead == 4)
        {
            mDirection = -Vector2.up * dirspeed*SpeedPlayer;
